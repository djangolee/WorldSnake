...
@interface URLComponetsViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation URLComponetsViewController
...
- (WSURLComponents *)URLComponents {
    [_URLComponents compactHead];
    [_URLComponents compactQuery];
